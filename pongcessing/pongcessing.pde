...
if (pos[1] > height-rad || pos[1] < rad) {direction[1] *= -1;}
...
if(keys[1]){
if(player1y < 620){player1y+= 10;}
}
if(keys[2]){
if(player2y > 0){player2y-= 10;}
}
if(keys[3]){
if(player2y + 100 < 720){player2y+= 10;}
}
text(score0,10,40);
text(score1,width-10,40);
}
void keyPressed(){
